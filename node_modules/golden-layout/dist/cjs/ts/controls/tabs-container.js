    ...
    tryUpdateTabSizes(dropdownActive, header, activeComponentItem) {
        ...
        if (this._tabs.length > 0) {
            ...
            for (let i = 0; i < numTabs; i++) {
                ...
                renderer(component.container, tab.titleElement, isActiveTab ? activeTabAvail : tabAvail, (isActiveTab ? tab_1.Tab.RenderFlags.IsActiveTab : 0) |
                    (dropdownActive ? tab_1.Tab.RenderFlags.DropdownActive : 0));
                ...
                if (dropdownActive) {
                    ...
                    renderer(component.container, el, w, (isActiveTab ? tab_1.Tab.RenderFlags.IsActiveTab : 0) |
                        tab_1.Tab.RenderFlags.DropdownActive |
                        tab_1.Tab.RenderFlags.InDropdownMenu);
                ...
                if (cumulativeTabWidth > availableWidth && numTabs > 1
                    ...
                    this.element.style.width = (0, utils_1.numberToPixels)(availableWidth);
                    cumulativeTabWidth = tabElement.offsetLeft - this._element.offsetLeft + tabElement.offsetWidth + tabMarginRight;
                }
            }
            if (cumulativeTabWidth > availableWidth) {
                ...
                for (let j = 0; j < numTabs; j++) {
                    const marginLeft = j === 0 ? ''
                        : '-' + (0, utils_1.numberToPixels)(overlap);
                ...
                if (activeElement.offsetLeft + activeElement.clientWidth
                    ...
                    if (activeIndex > 0) {
                        ...
                        for (let j = 1; j <= activeIndex; j++) {
                            ...
                            if (rightExcess > 0) {
                                this._tabs[j].element.style.marginLeft = '-' + (0, utils_1.numberToPixels)(overlap + rightExcess);
                            }
                        }
                    }
                }
